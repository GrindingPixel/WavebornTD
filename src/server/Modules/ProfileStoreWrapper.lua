...
local QuestDataModule = require(ReplicatedStorage:WaitForChild("QuestDataModule"))
...
local UnitDataModule = require(ReplicatedStorage:WaitForChild("UnitDataModule"))
local BattlepassInfoProvider = require(ReplicatedStorage:WaitForChild("BattlepassInfoProvider"))
...
local function onPlayerAdded(player)
	...
	local currentSeed = require(ReplicatedStorage.BattlepassInfoProvider).GetSeasonSeed()
